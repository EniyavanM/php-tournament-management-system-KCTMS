        ...
        <div class="mt-4 border-bottom">
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                    ...
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="admin_player_list.php">X</a></span>
                </div>
            </div>
            ...
            <form class="form-floating mb-3" method="GET" action="admin_player_list.php">
                <div class="row g-2">
                    <div class="col">
                    ...
                    <div class="col">
                        <select class="form-select" id="utype" name="ut">
                            ...
                            <option value="PLA">player</option>
                            <?php } ?>
                        </select>
                    </div>
                    <div class="col-auto">
                        ...
                        <button type="reset" class="btn btn-danger"
                            onclick="javascript: window.location='admin_player_list.php'">Clear</button>
    ...
    <div class="container pt-2" id="cust-table">
        ...
        <?php
            if(!isset($_GET["search"])){
                $search_query = "SELECT c_id,c_username,c_firstname,c_lastname,c_type,c_email FROM player;";
            }else{
                $search_un=$_GET["un"];
                $search_fn=$_GET["fn"];
                $search_ln=$_GET["ln"];
        ...
        <div class="row">
            <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                ...
                <a href="admin_player_list.php" class="text-white">Clear Search Result</a>
            </div>
        </div>
        <?php } else{ ?>
        ...
        <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-5">
            <caption><?php echo $search_numrow;?> player(s) <?php if(isset($_GET["search"])){?><br /><a
                    href="admin_player_list.php" class="text-decoration-none text-danger">Clear Search
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="admin_player_detail.php?c_id=<?php echo $row["c_id"]?>"
                            class="btn btn-sm btn-primary">View</a>
                        <a href="admin_player_edit.php?c_id=<?php echo $row["c_id"]?>"
                            class="btn btn-sm btn-outline-success">Edit</a>
                        <a href="admin_player_delete.php?c_id=<?php echo $row["c_id"]?>"
