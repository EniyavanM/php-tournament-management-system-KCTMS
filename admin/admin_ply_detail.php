...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="cart-body">
        ...
        <a class="btn btn-sm btn-outline-secondary" href="admin_pwd.php?c_id=<?php echo $_GET["c_id"]?>">
            <i  class="bi bi-key" ></i>
            Change password
        </a>
        <a class="btn btn-sm btn-primary mt-2 mt-md-0" href="admin_edit.php?c_id=<?php echo $_GET["c_id"]?>">
            <i class="bi bi-pencil-square"></i>
            Update profile
        </a>
        <a class="btn btn-sm btn-danger mt-2 mt-md-0" href="admin_delete.php?c_id=<?php echo $_GET["c_id"]?>">
