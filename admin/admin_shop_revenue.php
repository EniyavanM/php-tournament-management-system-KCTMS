...
<body class="d-flex flex-column h-100 bg-white">
    ...
    <div class="container px-5 py-4" id="tournamentnament-body">
        ...
        <h3 class="border-top pt-3 my-2">
            ...
            <span class="text-secondary">/</span> 
            <a class="nav-item text-decoration-none link-success" href="admin_tournamentnament_revenue.php?s_id=<?php echo $s_id?>">Revenue</a></span>
        </h3>
        </div>
        <div class="container form-signin">
        <form method="GET" action="admin_tournamentnament_report.php" class="form-floating">
            <input type="hidden" name="s_id" value="<?php echo $s_id;?>">
            <p>Please select the option below to see sales and revenue report of this tournamentnament.</p>
