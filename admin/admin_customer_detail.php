...
<head>
    ...
    <title>player Profile | kctms</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="cart-body">
        <div class="row my-4 pb-2 border-bottom">
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                    ...
                    <span class="ms-2 mt-2">Successfully updated player password!</span>
                </div>
            </div>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                    <i class="bi bi-x-circle ms-2"></i><span class="ms-2 mt-2">Failed to update player password.</span>
                </div>
            </div>
        ...
        <a class="btn btn-sm btn-outline-secondary" href="admin_player_pwd.php?c_id=<?php echo $_GET["c_id"]?>">
            <i  class="bi bi-key" ></i>
            Change password
        </a>
        <a class="btn btn-sm btn-primary mt-2 mt-md-0" href="admin_player_edit.php?c_id=<?php echo $_GET["c_id"]?>">
            <i class="bi bi-pencil-square"></i>
            Update profile
        </a>
        <a class="btn btn-sm btn-danger mt-2 mt-md-0" href="admin_player_delete.php?c_id=<?php echo $_GET["c_id"]?>">
        ...
        <?php
            ...
            $cid = $_GET["c_id"];
            $query = "SELECT c_username,c_firstname,c_lastname,c_email,c_gender,c_type FROM player WHERE c_id = {$cid} LIMIT 0,1";
