    ...
    <div class="container p-2 pb-0" id="admin-dashboard">
        <div class="mt-4 border-bottom">
            ...
            <form class="form-floating mb-3" method="GET" action="admin_matches_list.php">
                <div class="row g-2">
                    <div class="col">
                        <input type="text" class="form-control" id="f_name" name="f_name" placeholder="Team name"
                    ...
                    <div class="col-auto">
                        ...
                        <a href="admin_matches_add.php" class="btn btn-primary">Add new Match</a>
                    </div>
                </div>
            </form>
        </div>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="admin_matches_edit.php?s_id=<?php echo $row["s_id"];?>&f_id=<?php echo $row["f_id"]?>"
