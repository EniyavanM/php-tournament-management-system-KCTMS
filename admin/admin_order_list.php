...
<body class="d-flex flex-column h-100">
    ...
    <div class="container p-2 pb-0" id="admin-dashboard">
        <div class="mt-4 border-bottom">
            ...
            <h2 class="pt-3 display-6">player List</h2>
                    ...
                    <div class="col">
                        <select class="form-select" id="c_id" name="c_id">
                            ...
                            <?php
                                ...
                                FROM mreg_statusorh INNER JOIN player c ON orh.c_id = c.c_id;";
                    ...
                    <div class="col">
                        <select class="form-select" id="s_id" name="s_id">
                            ...
                            <?php
                                ...
                                FROM mreg_statusorh INNER JOIN tournament s ON orh.s_id = s.s_id;";
                                $option_result = $mysqli -> query($option_query);
                                $opt_row = $option_result -> num_rows;
                                if($option_result -> num_rows != 0){
                                    while($option_arr = $option_result -> fetch_array()){
    ...
    <?php
            if(isset($_GET["search"])){
                ...
                FROM mreg_statusorh INNER JOIN player c ON orh.c_id = c.c_id INNER JOIN payment p ON p.p_id = orh.p_id
                ...
                $query = "SELECT orh.orh_id,orh.orh_ordertime,c.c_firstname,c.c_lastname,orh.orh_orderstatus,p.p_amount,s.s_name,orh.t_id
                FROM mreg_statusorh INNER JOIN player c ON orh.c_id = c.c_id INNER JOIN payment p ON p.p_id = orh.p_id INNER JOIN tournament s ON orh.s_id = s.s_id ORDER BY orh.orh_ordertime DESC;";
            }
            ...
            <table class="table rounded-5 table-light table-striped table-hover align-middle caption-top mb-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="admin_mreg_detailphp?orh_id=<?php echo $row["orh_id"]?>" class="btn btn-sm btn-primary">View</a>
