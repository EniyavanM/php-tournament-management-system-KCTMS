...
<body class="d-flex flex-column h-100">
    <header class="navbar navbar-expand-md navbar-light fixed-top bg-light shadow-sm mb-auto">
        <div class="container-fluid mx-4">
            <a href="index.php">
                <img src="img/Color logo - no background.png" width="125" class="me-2" alt="kctmsgo">
            </a>
    ...
    <div class="container form-signin text-center restricted mt-auto">
            ...
            <h4 class="mt-2 mb-3 fw-normal ">Kumaraguru college of technology</h4>
            <p class="mt-2 mb-3 fw-normal h6 ">Department Of Computer Science and Engineering</p>
            <p class="mb-3 fw-bold text-bold text-wrap"></p>
            <h4 class="mt-2 mb-3 fw-normal "></h4><p class="mt-2 mb-3 fw-normal h6 "></p>
