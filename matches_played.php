...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="cart-body">
        <div class="row my-4">
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-success text-white rounded text-start">
                    ...
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="matches_played.php">X</a></span>
                </div>
            </div>
            ...
            <div class="row row-cols-1 notibar">
                <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                    ...
                    <span class="me-2 float-end"><a class="text-decoration-none link-light" href="Tournment_page.php">X</a></span>
                </div>
            </div>
            ...
            <h2 class="py-3 display-6 border-bottom">
                <i class="bi bi-person"></i>My Matches
            </h2>
        </div>
        ...
        <div class="row row-cols-1 row-cols-md-2 mb-5">
            <div class="col">
                <div class="row row-cols-1">
                    <div class="col">
                        <h5 class="fw-light">registration</h5>
                        <p class="fw-light">From
                            <?php 
                                $cart_query = "SELECT s_id,s_name FROM tournament s WHERE s_id = (SELECT s_id FROM cart WHERE c_id = {$_SESSION['cid']} LIMIT 0,1)";
                    ...
                    <div class="col">
                        <ul class="list-group">
                            ...
                            <?php
                                ...
                                FROM cart ct INNER JOIN matches f ON ct.f_id = f.f_id WHERE ct.c_id = {$_SESSION['cid']}";
                            ...
                            <li
                                ...
                                <div class="ms-3 mt-3 me-auto">
                                    <div class="fw-normal">
                                        ...
                                        <?php }else {?>
                                        <a href="ply_update_cart.php?s_id=<?php echo $cart_result["s_id"];?>&f_id=<?php echo $row["f_id"];?>"
                                            class="text-decoration-none text-success nav nav-item small"></a>
                                        <?php } ?>
                                    </div>
                            </li>
                            <!-- END CART ITEM -->
                        ...
                        <div class="col my-3">
                            <ul class="list-inline justify-content-between">
                                <li class="list-item mb-2">
                                    <a href="del_allmatches.php?rmv=1&s_id=<?php echo $cart_result["s_id"];?>"
                                        class="nav nav-item text-danger text-decoration-none small" name="rmv_all" id="rmv_all">
                                        Remove all the matches
                                    </a>
                                </li>
                                <li class="list-inline-item fw-normal h5 me-5">Total</li>
                    ...
                    <div class="col mb-3">
                        <div class="card p-2 p-md-4 border-0 border-bottom">
                            ...
                            <ul class="card-text list-unstyled m-0 p-0 small">
                                <?php 
                                    $cust_query = "SELECT c_email FROM player WHERE c_id = {$_SESSION['cid']} LIMIT 0,1";
        ...
        <div class="row row-cols-1 notibar">
            <div class="col mt-2 ms-2 p-2 bg-danger text-white rounded text-start">
                <i class="bi bi-x-circle ms-2"></i><span class="ms-2 mt-2">You have no played yet so far</span>
            </div>
        </div>
