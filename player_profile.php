...
<?php include('nav_header.php')?>
    ...
    <div class="container px-5 py-4" id="cart-body">
                ...
                if($_GET["up_pwd"]==1){
                    ...
                    <div class="row row-cols-1 notibar">
                        ...
                        <i class="bi bi-check-circle"></i>
                            ...
                            <span class="me-2 float-end"><a class="text-decoration-none link-light" href="player_profile.php">X</a></span>
                        </div>
                    </div>
        ...
        <a class="btn btn-sm btn-outline-secondary me-2" href="ply_update_pwd.php">
        <i class="bi bi-key"></i>
            Change password
        </a>
        <a class="btn btn-sm btn-primary mt-2 mt-md-0" href="ply_update_profile.php">
        ...
        <?php
            ...
            $query = "SELECT c_username,c_firstname,c_lastname,c_email,c_gender,c_type FROM player WHERE c_id = {$_SESSION['cid']} LIMIT 0,1";
