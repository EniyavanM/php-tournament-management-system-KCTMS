...
<head>
    ...
    <title>Order Detail | kctms</title>
</head>
...
<body class="d-flex flex-column h-100">
    ...
    <div class="container px-5 py-4" id="cart-body">
        <div class="row my-4 border-bottom">
            ...
            <h2 class="pt-3 display-6">Registratrion status</h2>

            <?php
                $orh_id = $_GET["orh_id"];
                $orh_query = "SELECT * FROM mreg_status WHERE orh_id = {$orh_id}";
            ...
            <div class="row row-cols-1 row-cols-md-2">
                <div class="col mb-2 mb-md-0">
                    <ul class="list-unstyled fw-light">
                        ...
                        <li class="list-item">From Admin for
                            <?php
                                $tournamentnament_query = "SELECT s_nametournamentM tournament WHERE s_id = {$orh_arr['s_id']};";
                                $tournamentnament_arr = $mysqli -> qtournament($tournament_query) -> fetch_array();
                                echo $tournamentnament_arr["s_name"];
                            ?>
                        </li>
                    </ul>
                </div>
                <div class="col">
                    <ul class="list-unstyled fw-light">
                        ...
                        ?>
                        <li class="mb-2">&nbsp;</li>
                        <li>Registered on <?php echo $od_placedate;?></li>
        ...
        <div class="row mb-5">
            <div class="col">
                <div class="row row-cols-1">
                    <div class="col">
                        <h5 class="fw-light">Status</h5>
                    </div>
                    <div class="col row row-cols-1 row-cols-md-2 border-bottom">
                        <?php 
                            $ord_query = "SELECT f.f_name,f.f_pic,ord.ord_amount,ord.ord_buyprice,ord_note FROM mreg_detail ord INNER JOIN matcheshes f ON ord.f_id = f.f_id WHERE ord.orh_id = {$orh_id}";
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item d-flex border-0 pb-3 border-bottom w-100 justify-content-between align-items-center">
                                    ...
                                    <div class="ms-3 me-auto">
                                        <div class="fw-normal"><span class="h5"> </span><?php echo $ord_row["f_name"]?>
                                            <p><?php printf("%.2f INR <small class='text-muted'></small>",$ord_row["ord_buyprice"]*$ord_row["ord_amount"],$ord_row["ord_buyprice"]);?><br />
                   ...
                   <!-- <div class="col my-3">
                        <ul class="list-inline justify-content-between">
                            ...
                            <li class="list-inline-item fw-bold h4">
                                <?php
                                    $gt_query = "SELECT SUM(ord_amount*ord_buyprice) AS gt FROM mreg_detail WHERE orh_id = {$orh_id}";
