...
CREATE TABLE `notifications` (
  ...
  `c_id` int(11) NOT NULL COMMENT 'Player ID from players table',
  `schedule_id` int(11) DEFAULT NULL COMMENT 'Reference to match schedule',
  `notification_type` enum('match_reminder','match_result','general','system') NOT NULL,
...
INSERT INTO `notifications` (`notification_id`, `c_id`, `schedule_id`, `notification_type`, `title`, `message`, `is_read`, `created_at`, `sent_at`) VALUES
(1, 8, 3, 'match_reminder', 'Upcoming Match', 'Your match is scheduled for March 25 at 11:30 AM at KCT', 0, '2025-03-25 09:30:00', '2025-03-25 09:30:00');
