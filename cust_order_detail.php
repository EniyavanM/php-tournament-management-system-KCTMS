            ...
            <div class="col">
                <div class="row row-cols-1">
                    ...
                    <div class="col row row-cols-1 row-cols-md-2 border-bottom">
                        <?php 
                            $ord_query = "SELECT f.f_name,f.f_pic,ord.ord_amount,ord.ord_buyprice,ord_note FROM mreg_detail ord INNER JOIN matches f ON ord.f_id = f.f_id WHERE ord.orh_id = {$orh_id}";
