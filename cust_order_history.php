...
<head>
    ...
    <title>Order History | kctms</title>
</head>
    ...
    <div class="container px-5 py-4" id="tournament-body">
        ...
        <div class="tab-content" id="nav-tabContent">
            ...
            <div class="tab-pane fade show active p-3" id="nav-ongoing" role="tabpanel" aria-labelledby="ongoing-tab">
                <?php
                $ongoing_query = "SELECT * FROM mreg_status WHERE c_id = {$_SESSION['cid']} AND orh_orderstatus <> 'FNSH';";
            ...
            ?>
                <div class="row row-cols-1 row-cols-md-3">
                    ...
                    <div class="col">
                        <a href="cust_mreg_detail.php?orh_id=<?php echo $og_row["orh_id"]?>"
                                ...
                                <div class="card-body">
                                    <div class="card-text row row-cols-1 small">
                                        ...
                                        <div class="col mb-2">From
                                            <?php
                                            $tournament_query = "SELECT s_name FROM tournament WHERE s_id = {$og_row['s_id']};";
                                            $tournament_arr = $mysqli -> query($tournament_query) -> fetch_array();
                                            echo $tournament_arr["s_name"];
                                        ?>
                                        </div>
                                        <?php
                                        $ord_query = "SELECT COUNT(*) AS cnt,SUM(ord_amount*ord_buyprice) AS gt FROM mreg_detail
